...
# modified by Ciaran Beggan on 14-Jan-2015 and 27-Jul-2015
# added in code to read and record temperature from TMP36 sensor
...
while 1:
	...
	c_out = numpy.mean(c)
        ...
        file1.write('%i %i %i %i %i %i %8.2f %8.2f %8.2f %8.2f %5.2f \n' %  (t()[0], t()[1], t()[2], t()[3], t()[4], t()[5],  x_out, y_out, z_out, f_out, c_out))
